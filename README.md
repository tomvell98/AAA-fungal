...
Large derived outputs (trees, distance matrices, embeddings, conservation/structure metrics, supplementary tables) are deposited on Zenodo (DOI: 10.5281/zenodo.18487039).
